...
class TrainingConfig:
    ...
    dataset_name: str = "../../smithsonian_butterflies_subset"
...
config.dataset_name = "../smithsonian_butterflies_subset"
...
for i, image in enumerate(dataset[:4]["image"]):
    ...
    axs[i].set_axis_off()
    plt.savefig(f'myplot{i}.png', dpi=300)
    # axs[i].set_axis_off()
# fig.show()
...
img_test = Image.fromarray(((noisy_image.permute(0, 2, 3, 1) + 1.0) * 127.5).type(torch.uint8).numpy()[0])
